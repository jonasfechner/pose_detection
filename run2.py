...
print("▶️ Starting inference and annotation...")
while True:
    ...
    if confidence < waterline:
        ...
        if in_valley:
            ...
            if (
                ...
                rep_count += 1
                print(f"✅ Detected valley at frame {valley_start}–{valley_end} | Volume: {valley_volume:.2f}")

    # Draw annotation
    if result.pose_landmarks:
        mp_drawing.draw_landmarks(frame, result.pose_landmarks, mp_pose.POSE_CONNECTIONS)

    cv2.putText(frame, f"Reps: {rep_count}", (out_width - 200, 50),
